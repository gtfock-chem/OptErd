...
#define ERD_RECORD_FLOPS (ERD_RECORD_K15_DPADD_FLOPS || ERD_RECORD_K15_DPMUL_FLOPS || ERD_RECORD_K15_DPFMA_FLOPS || ERD_RECORD_K15_DPDIVSQRT_FLOPS || ERD_RECORD_K15_DPANY_FLOPS)
