...
int erd__e0f0_pcgto_block (int nbatch, int nint2d,
                           int atomic, int atomab, int atomcd,
                           int nij, int nkl,
                           int ngqp, int nmom, int ngqscr, int mgqijkl,
                           ...
                           double tmax, double tstep, double tvstep,
                           int *prima, int *primb, int *primc, int *primd,
                           double *norma, double *normb,
                           double *normc, double *normd,
                           double *rhoab, double *rhocd,
                           double *p, double *px, double *py, double *pz,
                           ...
                           double *rts, double *wts, double *gqscr,
                           double *tval, double *pqpinv, double *scalepq,
