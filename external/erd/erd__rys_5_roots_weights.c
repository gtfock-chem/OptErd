/* erd__rys_5_roots_weights.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int
erd__rys_5_roots_weights_ (int * nt, int * ntgqp,
                            ...
                            double * wts)
{
    ...
    static double e;
    static int m, n;
    static double t, x, r1, r2, r3, r4, r5, w1, w2, w3, w4, w5;
    static int tcase;
