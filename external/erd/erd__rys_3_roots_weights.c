/* erd__rys_3_roots_weights.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int
erd__rys_3_roots_weights_ (int * nt, int * ntgqp,
                            ...
                            double * wts)
{
    ...
    static double e;
    static int m, n;
    static double t, x, y, z__, a1, a2, f1, f2, r1, r2, r3, t1, t2, t3,
        w1, w2, w3;
    static int tcase;
